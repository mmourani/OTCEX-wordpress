...
// THUMBNAIL
$post_img = '';
$thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'cryptic_blog_900x550' );
if ($thumbnail_src) {
...
<article id="post-<?php the_ID(); ?>" <?php post_class('single-post col-md-12 list-view blogloop-v4 blogloop-no-flex'); ?> > 
    <div class="blog_custom">
        ...
        <div class="post-details row">
            <div class="post-date-badge col-md-1">
                <!-- POST META: DATE -->
                <div class="post-date">
                    ...
                    <div class="post-excerpt row">
                        ...
                        <p>
                            <a href="<?php echo esc_url(get_the_permalink()); ?>" class="more-link">
                                <?php echo esc_html__( 'Continue Reading', 'cryptic' ); ?> <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                            </a>
                        </p>
                        <div class="clearfix"></div>
