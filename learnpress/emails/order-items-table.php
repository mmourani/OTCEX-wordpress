...
<table cellspacing="0" cellpadding="5" style="width: 100%; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;" border="1">
	<thead>
	<tr>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Course', 'cryptic' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Quantity', 'cryptic' ); ?></th>
		<th class="td" scope="col" style="text-align:left;"><?php _e( 'Price', 'cryptic' ); ?></th>
	</tr>
	</thead>
	<tbody>
	<?php foreach ( $order->get_items() as $item_id => $item ):
		...
		<tr>
			...
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
				<?php echo "\n" . sprintf( __( 'Quantity: %s', 'cryptic' ), apply_filters( 'learn_press_email_order_item_quantity', $item['quantity'], $item ) ); ?>
			</td>
			<td style="text-align:left; vertical-align:middle; border: 1px solid #eee; font-family: 'Helvetica Neue', Helvetica, Roboto, Arial, sans-serif;">
				<?php echo "\n" . sprintf( __( 'Cost: %s', 'cryptic' ), apply_filters( 'learn_press_email_order_item_cost', learn_press_format_price( $item['total'] ), $item ) ); ?>
			</td>
