...
$curriculum_heading = apply_filters( 'learn_press_curriculum_heading', __( 'Course Curriculum', 'cryptic' ) );
?>
<div class="course-curriculum" id="learn-press-course-curriculum">
	...
	<?php else: ?>
		<?php echo apply_filters( 'learn_press_course_curriculum_empty', __( 'Curriculum is empty', 'cryptic' ) ); ?>
	<?php endif; ?>
