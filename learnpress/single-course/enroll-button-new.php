...
if ( !$user->can( 'enroll-course', $course->id ) ) {
	learn_press_display_message( apply_filters( 'learn_press_user_can_not_enroll_course_message', __( 'Sorry! You can not buy this course right now. Please contact admin site for more information', 'cryptic' ), $course, $user ) );
	return;
}
