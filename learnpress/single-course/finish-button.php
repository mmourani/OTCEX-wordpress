...
<?php if ( $can_finish && ( $message = apply_filters( 'learn_press_finish_course_message', __( 'Congrats! You can finish this course right now.', 'cryptic' ) ) ) !== false ): ?>
