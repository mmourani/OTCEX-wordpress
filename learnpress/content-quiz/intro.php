...
<ul class="quiz-intro">
	<li>
		<label><?php _e( 'Attempts allowed:', 'cryptic' ); ?></label>
		<?php echo $quiz->retake_count; ?>
	</li>
	<li>
		<label><?php _e( 'Duration:', 'cryptic' ); ?></label>
		<?php echo $quiz->get_duration_html(); ?>
	</li>
	<li>
		<label><?php _e( 'Passing grade:', 'cryptic' ); ?></label>
		<?php echo sprintf( '%d%%', $quiz->passing_grade ); ?>
	</li>
	<li>
		<label><?php _e( 'Questions:', 'cryptic' ); ?></label>
