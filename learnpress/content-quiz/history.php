...
$heading       = sprintf( __( 'Other results (newest %d items)', 'cryptic' ), $limit );
...
if ( $history_count > 1 ) {
	...
	<div class="lp-group-content-wrap hide-if-js" id="lp-quiz-history">
		<table class="quiz-history">
			...
			<tr>
				...
				<th><?php _e( 'Time', 'cryptic' ); ?></th>
				<th><?php _e( 'Result', 'cryptic' ); ?></th>
			</tr>
			</thead>
	...
	learn_press_display_message( __( 'No history found!', 'cryptic' ) );
}