	...
	<table class="learn-press-cart-table">
		<thead>
			<tr>
				...
				<th class="course-name"><?php _e( 'Course', 'cryptic' ); ?></th>
				<th class="course-price"><?php _e( 'Price', 'cryptic' ); ?></th>
				<th class="course-total"><?php _e( 'Total', 'cryptic' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		?>
		<tr>
			<td colspan="3"><?php _e( 'Subtotal', 'cryptic' );?></td>
			<td><?php echo $cart->get_subtotal();?></td>
		</tr>
		<tr>
			<td colspan="3"><?php _e( 'Total', 'cryptic' );?></td>
			<td><?php echo $cart->get_total();?></td>
		</tr>
		<?php do_action( 'learn_press_after_cart_contents' ); ?>
		</tbody>
	</table>
	<button class="checkout-button"><?php _e( 'Checkout', 'cryptic' );?></button>
