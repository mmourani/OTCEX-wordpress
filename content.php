...
// THUMBNAIL
$post_img = '';
$thumbnail_src = wp_get_attachment_image_src( get_post_thumbnail_id( get_the_ID() ), 'cryptic_about_625x415' );
if ($thumbnail_src) {
        ...
        <div class="<?php echo esc_attr($post_col); ?> post-details">
            <div class="post-details-padding">
                ...
                <?php
                    ...
                    the_content( sprintf(__( 'Read More <i class="fa fa-long-arrow-right" aria-hidden="true"></i>', 'cryptic' ),
